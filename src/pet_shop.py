...
# Position 0 already defined in test, use dict key for cash & a return. 
...
# Error 16 
# add_pet_to_customer requires definition.
# Append Bors the Yonger (new_pet) to Alices pets (customer [0]) using append dict key. 
